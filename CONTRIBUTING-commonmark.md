...
development. **Notebooks are the single source of truth** — never edit
`.py` files directly.
...
- **detect-private-key** — blocks commits containing RSA/DSA/EC private
  keys
- **detect-secrets** — catches high-entropy strings (tokens, keys,
  account locators)
...
All library code lives in `00_core.ipynb`, `01_async.ipynb`, and
`02_mcp_client.ipynb`. After editing:
...
<td>Sets which module this notebook exports to</td>
</tr>
<tr>
<td><code>#\| export</code></td>
<td>Marks a cell for export to the .py module</td>
</tr>
<tr>
<td><code>#\| hide</code></td>
<td>Hides cell from documentation</td>
</tr>
<tr>
<td><code>#\| eval: false</code></td>
<td>Skips cell during <code>nbdev-test</code> (use for live API
calls)</td>
</tr>
</tbody>
</table>
...
2.  **Do not** include `#| default_exp` — demo notebooks don’t export
    code
3.  Import from the library: `from mcp_ski_resort.core import ...`
4.  Mark all live API cells with `#| eval: false` so `nbdev-test`
